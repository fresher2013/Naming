...
public class PinyinActivity extends Activity implements OnCheckedChangeListener,
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.menu_item_ok) {
            ...
            if (size > 0) {
                ...
                String temp = Utils.allInOne(selected, "@");
                Log.e("pinyin", temp);
    ...
    private class PinyinAdapter extends BaseAdapter implements SectionIndexer {
        ...
        public void refreshDataSet() {
            ...
            mSelectedPinyins = mUserSelectedPinyins
                    .toArray(new String[mUserSelectedPinyins.size()]);
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        if (isChecked) {
            if (!mUserSelectedPinyins.contains(pinyin))
                mUserSelectedPinyins.add(pinyin);
        } else {
            if (mUserSelectedPinyins.contains(pinyin))
