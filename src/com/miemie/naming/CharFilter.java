    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMaxStroke.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                ...
                mMaxHeader.setText(new StringBuilder(getString(R.string.MaxStrokeInCharacter))
                        .append(":")
        ...
        mMinStroke.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                ...
                mMinHeader.setText(new StringBuilder(getString(R.string.MinStrokeInCharacter))
                        .append(":")
                        .append(seekBar.getProgress()).toString());
            }
        ...
        if (item.getItemId() == R.id.menu_item_ok) {
            ...
            new Thread() {
                public void run() {
                    ...
                    String resultString = Utils.allInOne(temp,"@");
