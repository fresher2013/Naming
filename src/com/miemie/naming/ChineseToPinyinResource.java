...
public class ChineseToPinyinResource {
   ...
   */
  public Properties getUnicodeToHanyuPinyinTable() {
   ...
   */
  ChineseToPinyinResource(Context context) {
    mContext = context;
    initializeResource();
  }
  ...
  private void initializeResource() {
    try {
      ...
      getUnicodeToHanyuPinyinTable().load(mContext.getAssets().open(resourceName));
  ...
  String[] getHanyuPinyinStringArray(char ch) {
    ...
    if (!TextUtils.isEmpty(pinyinRecord)) {
